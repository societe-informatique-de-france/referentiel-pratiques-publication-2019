...
summary(experience)
experience$theme = as.factor(answers$theme)
experience$asso = as.factor(answers$assoc)
levels(experience$theme) = c("Algo/RO", "Archi", "Bioinfo", "GL/Prog", "Images", "Info Fond.", "Info Indus", "IA", "IHM", "Mod/Simu", "Réseaux", "Sys Inf/ion", "Sys Inf/ues")
boxplot(experience[,1]~experience[,2], las=3)
boxplot(experience[,1]~experience[,3], las=3)
```
